    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text2)", marginTop: "0.25rem" }}>
            {devices.length} device(s) · Rafraîchissement auto 10s
          </p>
        </div>
        <a
          href="/onboard"
      ...
      {loading ? (
        ...
        >
          ...
          <a href="/onboard" style={{ color: "var(--accent)", textDecoration: "none" }}>
            Ajouter votre premier device →
          </a>
        </div>
      ) : (
            ...
            >
              ...
              >
                ...
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  ...
                  >
                    {pinging === d.deviceId ? "Ping..." : "📡 Ping"}
                  </button>
                  <a
                    href={`/draw/${d.deviceId}/${d.screens[0]}`}
                    style={{
                      padding: "0.4rem 0.875rem",
                      borderRadius: "6px",
                      border: "none",
              ...
              <div style={{ marginTop: "1rem", display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
                {d.screens.map((sid) => {
                  // Vérification explicite + type guard sécurisé
                  if (!(sid in SCREEN_PROFILES)) {
                    return null;
                  }
                  
                  const p = SCREEN_PROFILES[sid as keyof typeof SCREEN_PROFILES];
                  if (!p) return null;
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
          {[
            ...
            <div
              key={s.fn}
              style={{ display: "flex", gap: "1rem", fontSize: "0.8rem", alignItems: "center" }}
            >
              <span
                style={{
                  fontFamily: "JetBrains Mono, monospace",
