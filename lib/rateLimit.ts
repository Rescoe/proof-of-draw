...
// AUTO_BLACKLIST désactivé en dev relaxed, toujours actif en prod
...
interface RateLimitOptions {
  ...
  strikeId?:   string;       // ID à striker en cas d'abus
...
export async function checkRateLimit(opts: RateLimitOptions): Promise<RateLimitResult> {
  ...
  // Pipeline atomique : INCR + EXPIRE NX dans le même round-trip.
  // "NX" = pose le TTL uniquement si la clé n'en a pas encore.
